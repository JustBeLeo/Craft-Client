    ...
    class TabView extends LinearLayout {
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (maxWidth <= 0 || specWidthMode != 0 && specWidthSize <= maxWidth) {
                ...
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(GlueTabLayout.this.tabMaxWidth, -2147483648);
            }
        ...
        final void update() {
            ...
            if (this.customView == null) {
                if (this.iconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(this.getContext()).inflate(0x7f0b0021, this, false);
                ...
                if (this.textView == null) {
                    TextView textView = (TextView) LayoutInflater.from(this.getContext()).inflate(0x7f0b0022, this, false);
